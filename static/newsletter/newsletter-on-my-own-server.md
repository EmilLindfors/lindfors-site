...
url: "https://lindfors.no/blog/newsletter-on-my-own-server/?issue=newsletter-on-my-own-server"
---
...
The [February post](https://lindfors.no/blog/self-hosted-newsletter/?issue=newsletter-on-my-own-server) made a virtue of having no database. Subscribe was a Worker on Cloudflare, the list was a Stalwart mailing list, and that was the whole system. With zero subscribers and a free tier, that was the right call. It is also how a mail server ended up being used as a key-value store.
...
*[Read the full post on the site](https://lindfors.no/blog/newsletter-on-my-own-server/?issue=newsletter-on-my-own-server) for math equations, citations, and interactive features.*
