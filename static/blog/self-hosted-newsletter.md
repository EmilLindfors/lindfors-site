...
400](https://lindfors.no/blog/newsletter-one-click-unsubscribe/).
...
It held up better than I expected. When I added double opt-in six months later, the obvious cost was a pending-subscribers table -- and it turned out not to need one. That is the [follow-up post](https://lindfors.no/blog/newsletter-one-click-unsubscribe/).
