...
canonical: https://lindfors.no/blog/self-hosted-newsletter/
---
...
That last sentence is the one I did not expect to write in February. Sovereignty over your own data has become a live question in the EU this year, and I wrote about the same trend on the model side in [the Codex fork post](https://lindfors.no/blog/forking-codex-for-any-endpoint/): the customer who can leave is the customer who is fine. Mail is the oldest federated system we have. It was designed so that anyone can run a node, and after a decade in which that stopped being practical, it is practical again.
...
- Bathelt, H., Malmberg, A., & Maskell, P. "Clusters and knowledge: local buzz, global pipelines and the process of knowledge creation". *Progress in Human Geography*, vol. 28, no. 1, pp. 31-56, 2004. [doi:10.1191/0309132504ph469oa](https://doi.org/10.1191/0309132504ph469oa)
- Granovetter, M. S. "The Strength of Weak Ties". *American Journal of Sociology*, vol. 78, no. 6, pp. 1360-1380, 1973. [doi:10.1086/225469](https://doi.org/10.1086/225469)
