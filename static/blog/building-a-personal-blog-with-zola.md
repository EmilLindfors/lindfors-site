...
**Deep-dive: [I replaced Mailchimp with a Rust Worker and a self-hosted mail server](https://lindfors.no/blog/self-hosted-newsletter/)**
...
**Deep-dive: [Proper citations on a static site: Zotero, Rust, and Typst](https://lindfors.no/blog/citations-on-a-static-site/)**
...
**Deep-dive: [I use Typst to generate PDFs of my blog posts and my CV](https://lindfors.no/blog/typst-for-blogging/)**
