...
I was looking at telemetry for something else when I noticed a run of 400s on `/api/unsubscribe`. Not many. Enough to remind me that I [built a newsletter in February](/blog/self-hosted-newsletter/) and then stopped thinking about it.
