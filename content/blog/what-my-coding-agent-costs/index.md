...
The two previous posts in this series were about pointing a coding agent at [whichever endpoint a client will approve](/blog/which-llm-are-we-allowed-to-use), and [the code that made that possible](/blog/forking-codex-for-any-endpoint). Both of them make cost claims. This one is about how I know those numbers, which took considerably longer than the fork did.
