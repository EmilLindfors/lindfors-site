...
The [first post in this series](/blog/which-llm-are-we-allowed-to-use) argues why a consultancy needs that control. This one shows how we got it, what broke, and what a book about computer hardware from 2000 has to say about which part of the fork actually mattered.
...
One of the cosmetic patches turns the agent's own telemetry off by default. That is the right default for a tool handed to consultants. Pointed at a collector you run yourself it becomes useful again, and the [next post](/blog/what-my-coding-agent-costs) is about getting real cost numbers out of it, including the part where Codex's token metrics report zero.
