...
changelog = [
    { date = 2026-09-04, description = "Checked against OpenAI's technical report: the count of unsolvable tasks, the May origin of the message board, the 19 July activity on OpenAI's own clusters, what training reinforced, and the 100x figure for the production system prompt." },
]
